...
class AliPay:
    ...
    def common_pay(self, method, subject, out_trade_no, total_amount, return_url=None, **kwargs):
        biz_content = {
            'subject': subject,
...
def test():
    ...
    alipay = AliPay(
        appid='2017080508049336',
        app_notify_url='http://118.24.157.119:8000/alipay/return/',
        app_private_key_path='/www/MercenaryBackend/apps/utils/keys/private_2048.txt',
        alipay_public_key_path='/www/MercenaryBackend/apps/utils/keys/alipay_public_2048.txt',
        debug=True,  # 默认False,
        return_url='http://118.24.157.119:8000/alipay/return/'
    )
