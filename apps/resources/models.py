...
class ResourceCategory(models.Model):
    ...
    image = models.ImageField(null=True, blank=True, upload_to='resource/category', verbose_name='主页图标')
...
class ResourceMaterial(models.Model):
    ...
    category = models.ForeignKey(ResourceCategory, null=True, blank=True, verbose_name='所属分类')
