# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-04-19 18:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classification', models.CharField(choices=[('1', '即时'), ('2', '顺风'), ('3', '替身'), ('4', '技能'), ('5', '活动')], help_text='所属分类', max_length=2, verbose_name='父分类')),
                ('template', models.CharField(choices=[('1', '描述'), ('2', '商品'), ('3', '快递')], default='1', help_text='分类数据所使用的模板', max_length=2, verbose_name='分类模板')),
            ],
            options={
                'verbose_name': '分类',
