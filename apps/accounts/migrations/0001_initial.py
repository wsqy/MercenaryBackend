    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.CharField(blank=True, help_text='来源订单', max_length=30, null=True, verbose_name='来源订单')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('card_no', models.CharField(help_text='银行卡号', max_length=64, verbose_name='银行卡号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('1', '待处理'), ('2', '提现完成'), ('3', '提现异常')], default='1', help_text='提现状态', max_length=1, verbose_name='状态')),
                ('remark', models.CharField(blank=True, help_text='备注信息', max_length=128, null=True, verbose_name='备注信息')),
